...
async def async_setup_entry(
    ...
    async_add_entities(PinecilSetting(data, description) for description in ENTITIES)
...
class PinecilSetting(CoordinatorEntity, NumberEntity):
    ...
    def __init__(
        self, pinecil: PinecilWrapper, description: PinecilNumberEntityDescription
    ):
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        await self.pinecil.client.set_one_setting(
